...
if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) == 'object' && window.window === window) {
    ...
    exports.root = self;
} else if ((typeof commonjsGlobal === 'undefined' ? 'undefined' : _typeof(commonjsGlobal)) == 'object' && commonjsGlobal.global === commonjsGlobal) {
...
var OfflineAudioNodeProxy = function () {
    function OfflineAudioNodeProxy(_ref) {
        var _ref$channelCount = _ref.channelCount,
            channelCount = _ref$channelCount === undefined ? 2 : _ref$channelCount,
            ...
            offlineAudioContext = _ref.offlineAudioContext;
...
var OfflineAudioBufferSourceNodeFakerProxy = function (_OfflineAudioNodeProx) {
    ...
    function OfflineAudioBufferSourceNodeFakerProxy(_ref) {
        ...
        var _this = _possibleConstructorReturn(this, (OfflineAudioBufferSourceNodeFakerProxy.__proto__ || Object.getPrototypeOf(OfflineAudioBufferSourceNodeFakerProxy)).call(this, {
    ...
    _createClass$6(OfflineAudioBufferSourceNodeFakerProxy, [{
        ...
        get: function get() {
            ...
            var audioParam = {
                cancelScheduledValues: function cancelScheduledValues(startTime) {
...
var OfflineAudioBufferSourceNodeFaker = function () {
    function OfflineAudioBufferSourceNodeFaker(_ref2) {
        var fakeNodeStore = _ref2.fakeNodeStore,
            offlineAudioContext = _ref2.offlineAudioContext;
    ...
    _createClass$6(OfflineAudioBufferSourceNodeFaker, [{
        ...
        value: function render(offlineAudioContext) {
            ...
            var promises = Array.from(this._sources).map(function (_ref3) {
                ...
                return source.render(offlineAudioContext).then(function (node) {
...
var OfflineAudioBufferSourceNodeFakerFactory = function () {
    ...
    _createClass$6(OfflineAudioBufferSourceNodeFakerFactory, [{
        ...
        value: function create(_ref5) {
            var fakeNodeStore = _ref5.fakeNodeStore,
                offlineAudioContext = _ref5.offlineAudioContext;
...
var UNPATCHED_OFFLINE_AUDIO_CONTEXT_CONSTRUCTOR_PROVIDER = {
    ...
    useFactory: function useFactory(window$$1) {
        return window$$1.hasOwnProperty('OfflineAudioContext') ? window$$1.OfflineAudioContext : window$$1.hasOwnProperty('webkitOfflineAudioContext') ? window$$1.webkitOfflineAudioContext : null;
    }
};
...
var __metadata = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$6(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var OfflineIIRFilterNodeFaker = function () {
    function OfflineIIRFilterNodeFaker(_ref2) {
        var fakeNodeStore = _ref2.fakeNodeStore,
            ...
            unpatchedOfflineAudioContextConstructor$$1 = _ref2.unpatchedOfflineAudioContextConstructor;
        ...
        this._sources = new Map();
        this._unpatchedOfflineAudioContextConstructor = unpatchedOfflineAudioContextConstructor$$1;
        fakeNodeStore.set(this._proxy, this);
    }
    ...
    _createClass$11(OfflineIIRFilterNodeFaker, [{
        ...
        value: function render(offlineAudioContext) {
            ...
            if (this._nativeNode) {
                ...
                var _promises = Array.from(this._sources).map(function (_ref3) {
            ...
            var promises = Array.from(this._sources).map(function (_ref5) {
                ...
                // For some reason this currently needs to be a function body with a return statement. The shortcut syntax causes an error.
                return source.render(partialOfflineAudioContext).then(function (node) {
            ...
            return Promise.all(promises).then(function () {
                ...
                audioBufferSourceNode.buffer = _this2._applyFilter(renderedBuffer, offlineAudioContext);
                audioBufferSourceNode.start(0);
                _this2._node = audioBufferSourceNode;
                return _this2._node;
            });
        }
    }, {
...
var OfflineIIRFilterNodeFakerFactory = function () {
    ...
    _createClass$11(OfflineIIRFilterNodeFakerFactory, [{
        ...
        value: function create(_ref7) {
            var fakeNodeStore = _ref7.fakeNodeStore,
                feedback = _ref7.feedback,
                feedforward = _ref7.feedforward,
                length = _ref7.length,
                nativeNode = _ref7.nativeNode,
                numberOfChannels = _ref7.numberOfChannels,
                offlineAudioContext = _ref7.offlineAudioContext,
                sampleRate = _ref7.sampleRate;
...
OfflineIIRFilterNodeFakerFactory = __decorate([Injectable(), __param(0, Inject(unpatchedOfflineAudioContextConstructor)), __metadata("design:paramtypes", [Object, InvalidStateErrorFactory, NotSupportedErrorFactory, PromiseSupportTester])], OfflineIIRFilterNodeFakerFactory);
...
var __metadata$1 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$7(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
IIRFilterNodeFaker = __decorate$1([Injectable(), __metadata$1("design:paramtypes", [InvalidAccessErrorFactory, InvalidStateErrorFactory, NotSupportedErrorFactory])], IIRFilterNodeFaker);
...
var UNPATCHED_AUDIO_CONTEXT_CONSTRUCTOR_PROVIDER = {
    ...
    useFactory: function useFactory(window$$1) {
        return window$$1.hasOwnProperty('AudioContext') ? window$$1.AudioContext : window$$1.hasOwnProperty('webkitAudioContext') ? window$$1.webkitAudioContext : null;
    }
};
...
var __metadata$2 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$8(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var ConnectingSupportTester = function () {
    function ConnectingSupportTester(_unpatchedAudioContextConstructor) {
        _classCallCheck$18(this, ConnectingSupportTester);

        this._unpatchedAudioContextConstructor = _unpatchedAudioContextConstructor;
    }
    ...
    _createClass$18(ConnectingSupportTester, [{
        ...
        value: function test(audioContext) {
            ...
            var analyserNode = audioContext.createAnalyser();
            var anotherAudioContext = new this._unpatchedAudioContextConstructor();
            try {
...
ConnectingSupportTester = __decorate$2([Injectable(), __param$1(0, Inject(unpatchedAudioContextConstructor)), __metadata$2("design:paramtypes", [Object])], ConnectingSupportTester);
...
var __metadata$3 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$9(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
AudioBufferWrapper = __decorate$3([Injectable(), __metadata$3("design:paramtypes", [IndexSizeErrorFactory])], AudioBufferWrapper);
...
var __metadata$4 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$10(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
var AudioNodeConnectMethodWrapper = function () {
    ...
    _createClass$25(AudioNodeConnectMethodWrapper, [{
        key: "wrap",
        value: function wrap(audioNode, isSupportingChaining) {
            var _this = this;
...
AudioNodeConnectMethodWrapper = __decorate$4([Injectable(), __metadata$4("design:paramtypes", [InvalidAccessErrorFactory])], AudioNodeConnectMethodWrapper);
...
var __metadata$5 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$11(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
ChannelMergerNodeWrapper = __decorate$5([Injectable(), __metadata$5("design:paramtypes", [InvalidStateErrorFactory])], ChannelMergerNodeWrapper);
...
var __metadata$6 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$12(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
ChannelSplitterNodeWrapper = __decorate$6([Injectable(), __metadata$6("design:paramtypes", [InvalidStateErrorFactory])], ChannelSplitterNodeWrapper);
...
var __metadata$7 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$13(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
IIRFilterNodeGetFrequencyResponseMethodWrapper = __decorate$7([Injectable(), __metadata$7("design:paramtypes", [NotSupportedErrorFactory])], IIRFilterNodeGetFrequencyResponseMethodWrapper);
    ...
    useFactory: function useFactory(analyserNodeGetFloatTimeDomainDataMethodWrapper, analyserNodeGetFloatTimeDomainDataSupportTester, audioBufferCopyChannelMethodsSupportTester, audioBufferCopyChannelMethodsWrapper, audioBufferSourceNodeStopMethodWrapper, audioBufferWrapper, audioNodeConnectMethodWrapper, audioNodeDisconnectMethodWrapper, chainingSupportTester, channelMergerNodeWrapper, channelSplitterNodeWrapper, connectingSupportTester, dataCloneErrorFactory, detachedAudioBuffers, disconnectingSupportTester, encodingErrorFactory, invalidStateErrorFactory, iIRFilterNodeFaker, iIRFilterNodeGetFrequencyResponseMethodWrapper, promiseSupportTester, stopStoppedSupportTester, unpatchedAudioContextConstructor$$1) {
        var AudioContext = function () {
            function AudioContext() {
                ...
                var unpatchedAudioContext = new unpatchedAudioContextConstructor$$1();
...
var __metadata$8 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$14(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var CloseSupportTester = function () {
    function CloseSupportTester(_unpatchedAudioContextConstructor) {
    ...
    _createClass$30(CloseSupportTester, [{
        ...
        value: function test() {
            ...
            var audioContext = new this._unpatchedAudioContextConstructor();
...
CloseSupportTester = __decorate$8([Injectable(), __param$2(0, Inject(unpatchedAudioContextConstructor)), __metadata$8("design:paramtypes", [Object])], CloseSupportTester);
...
var __metadata$9 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$15(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var DecodeAudioDataTypeErrorSupportTester = function () {
    function DecodeAudioDataTypeErrorSupportTester(_unpatchedAudioContextConstructor) {
...
DecodeAudioDataTypeErrorSupportTester = __decorate$9([Injectable(), __param$3(0, Inject(unpatchedAudioContextConstructor)), __metadata$9("design:paramtypes", [Object])], DecodeAudioDataTypeErrorSupportTester);
...
var __metadata$10 = undefined && undefined.__metadata || function (k, v) {
    if ((typeof Reflect === "undefined" ? "undefined" : _typeof$16(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var MergingSupportTester = function () {
    function MergingSupportTester(_unpatchedAudioContextConstructor) {
...
MergingSupportTester = __decorate$10([Injectable(), __param$4(0, Inject(unpatchedAudioContextConstructor)), __metadata$10("design:paramtypes", [Object])], MergingSupportTester);
