...
export var IsSupportedPromise = new OpaqueToken('IS_SUPPORTED_PROMISE'); // tslint:disable-line:variable-name
...
export var IS_SUPPORTED_PROMISE_PROVIDER = {
    ...
    useFactory: function (closeSupportTester, decodeAudioDataTypeErrorSupportTester, mergingSupportTester, modernizr) {
        if (modernizr.promises && modernizr.typedarrays && modernizr.webaudio && closeSupportTester.test()) {
            return Promise
                ...
                .then(function (_a) {
                var decodeAudioDataTypeErrorSupport = _a[0], mergingSupport = _a[1];
...
//# sourceMappingURL=/users/chrisguttandin/repositories/standardized-audio-context/node_modules/tsconfig-holy-grail/src/providers/is-supported-promise.js.map